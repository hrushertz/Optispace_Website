...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Basic validation - updated for required fields
        if (empty($firstName) || empty($lastName) || empty($email) || empty($phone) || empty($companyName) || empty($currentChallenges)) {
            ...
            <?php if ($formSuccess): ?>
                <div class="pulse-form-card" style="text-align: center; padding: 4rem;">
                    ...
                    <p
                        ...
                        Our associate support team will contact you, thank you</p>
                    ...
                    <form id="pulseCheckForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>#request-form">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group span-3">
                                <label for="currentChallenges">Current Challenges <span class="required">*</span></label>
                                <textarea id="currentChallenges" name="currentChallenges" class="form-input"
                                    placeholder="What are the main challenges you're facing? (e.g., space constraints, inefficient material flow, high WIP inventory, poor utilization...)"
                                    required></textarea>
                            </div>
                        </div>

                        <button type="button" class="form-toggle-btn" id="toggleOptionalFields">
                        ...
                        <div class="collapsible-fields" id="optionalFields">
                            <!-- Supplementary Info -->
                            <div class="form-section-title">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M12 20h9" />
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="designation" name="designation" class="form-input"
                                        placeholder="e.g., Plant Manager, VP Operations">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="facilityCountry">Country</label>
                                ...
                                <div class="form-group span-3">
                                    ...
                                    <select id="projectType" name="projectType" class="form-input">
                                        ...
                                        <option value="lightgreenfield">Light Greenfield (Only Workplace Layout Design for
                                            New Building)</option>
                            ...
                            if (toggleBtn && optionalFields) {
                                toggleBtn.addEventListener('click', function () {
                                    ...
                                    if (optionalFields.classList.contains('show')) {
                                        span.textContent = 'Hide Optional Details';
                                    } else {
                                        span.textContent = 'Show More Details (Optional)';
                                    }
                                });
                            }
                        });
