        ...
        if (empty($firstName) || empty($lastName) || empty($email) || empty($phone) || empty($companyName) || empty($industry) || empty($facilityAddress) || empty($facilityCity) || empty($facilityState) || empty($projectType)) {
            ...
            if (!$stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    error_log("Pulse Check form: MAIL_ENABLED = " . var_export($mailEnabled, true));
                    ...
                    if ($mailEnabled === true || $mailEnabled === 'true') {
                        ...
                        error_log("Pulse Check form: Attempting to send email notification");
                        $notificationResult = sendPulseCheckNotification($emailData);

                        if ($notificationResult['success']) {
                            error_log("Pulse Check form: Email sent successfully");
                        } else {
                        ...
                        error_log("Pulse Check form: Email notifications disabled (MAIL_ENABLED not true)");
                    }
...
// Fetch Active Banners for Pulse Check Page
$bannerQuery = "SELECT * FROM banner_settings WHERE page_name = 'pulse-check' AND is_active = 1 ORDER BY sort_order ASC, created_at DESC";
...
// Fallback for Pulse Check Banner
if (empty($activeBanners)) {
    $activeBanners[] = [
        'image_path' => '',
        'eyebrow_text' => 'Free Factory Assessment',
        'heading_html' => 'Request a <span>Pulse Check</span>',
...
<style>
   ...
   ======================================== */
    ...
    .hero-slide-content .pulse-hero-content {
        opacity: 0;
        transform: translateY(30px);
        transition: all 1s cubic-bezier(0.16, 1, 0.3, 1);
    }

    .hero-slide-content:not(.active) .pulse-hero-content {
        transform: translateY(-20px);
        opacity: 0;
        transition: all 0.5s ease;
    }

    .hero-slide-content.active .pulse-hero-content {
        opacity: 1;
            ...
            <?php foreach ($activeBanners as $index => $banner): ?>
                <div class="hero-slide-content <?php echo $index === 0 ? 'active' : ''; ?>"
                    ...
                    <div class="pulse-hero-content">
                        ...
                        <p class="pulse-hero-text"><?php echo htmlspecialchars($banner['subheading']); ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="pulse-container">
        <div class="what-is-grid">
            <div class="what-is-content">
                ...
                <p>A Pulse Check is our complimentary on-site visit where we assess your current facility, understand
                    your challenges, and identify areas for potential improvement. Think of it as a health check for
                    your factory.</p>
                ...
                <div class="pulse-highlights">
                    <div class="highlight-item">
                        ...
                        <div class="highlight-content">
                            ...
                            <p>The Pulse Check is complimentary. We invest our time to understand your needs and
                                demonstrate our value.</p>
                        </div>
                    </div>
                    <div class="highlight-item">
                        ...
                        <div class="highlight-content">
                            ...
                            <p>Sometimes it takes an outside perspective to spot inefficiencies that have become
                                invisible over time.</p>
                        </div>
                    </div>
                    <div class="highlight-item">
                        ...
                        <div class="highlight-content">
                            ...
                            <p>We provide immediate feedback on potential quick wins and longer-term improvement
                                opportunities.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="pulse-form-wrapper">
            <?php if ($formSuccess): ?>
                <div class="pulse-form-card" style="text-align: center; padding: 4rem;">
                    <div
                        style="width: 80px; height: 80px; background: var(--pulse-green-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 2rem;">
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--pulse-green)"
                            stroke-width="2">
                            <polyline points="20 6 9 17 4 12" />
                        </svg>
                    </div>
                    ...
                    <p
                        style="font-size: 1.1rem; color: var(--pulse-text); max-width: 500px; margin: 0 auto 2rem; line-height: 1.7;">
                        Your Pulse Check request has been submitted successfully. Our team will review your information and
                        contact you shortly to schedule your complimentary assessment.</p>
                    <a href="<?php echo url('index.php'); ?>"
                        style="display: inline-flex; align-items: center; gap: 0.5rem; background: var(--pulse-orange); color: white; padding: 1rem 2rem; border-radius: 8px; text-decoration: none; font-weight: 600;">
            ...
            <?php else: ?>
                <div class="pulse-form-card">
                    ...
                    <?php if ($formError): ?>
                        <div
                            style="background: #FEF2F2; border: 1px solid #FECACA; border-radius: 8px; padding: 1rem 1.25rem; margin-bottom: 2rem; display: flex; align-items: center; gap: 0.75rem; color: #991B1B;">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <line x1="12" y1="8" x2="12" y2="12" />
                                <line x1="12" y1="16" x2="12.01" y2="16" />
                    ...
                    <form id="pulseCheckForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>#request-form">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="designation" name="designation" class="form-input"
                                    placeholder="e.g., Plant Manager, VP Operations" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group span-2">
                                ...
                                <input type="text" id="facilityAddress" name="facilityAddress" class="form-input"
                                    placeholder="Street address or area" required>
                            </div>
                            <div class="form-group">
                                <label for="facilityCity">City <span class="required">*</span></label>
                                <input type="text" id="facilityCity" name="facilityCity" class="form-input"
                                    placeholder="City" required>
                            </div>
                            <div class="form-group">
                                <label for="facilityState">State <span class="required">*</span></label>
                                <input type="text" id="facilityState" name="facilityState" class="form-input"
                                    placeholder="State" required>
                            </div>
                            <div class="form-group">
                                <label for="facilityCountry">Country <span class="required">*</span></label>
                                <input type="text" id="facilityCountry" name="facilityCountry" class="form-input"
                                    placeholder="Country" value="India" required>
                            </div>
                            <div class="form-group">
                                <label for="facilitySize">Facility Size (sq. ft.)</label>
                                <input type="text" id="facilitySize" name="facilitySize" class="form-input"
                        ...
                        <div class="form-grid">
                            <div class="form-group span-3">
                                ...
                                <select id="projectType" name="projectType" class="form-input" required>
                                    ...
                                    <option value="lightgreenfield">Light Greenfield (Only Workplace Layout Design for New
                                        Building)</option>
                            ...
                            <div class="form-group span-3">
                                ...
                                <textarea id="currentChallenges" name="currentChallenges" class="form-input"
                                    placeholder="What are the main challenges you're facing? (e.g., space constraints, inefficient material flow, high WIP inventory, poor utilization...)"></textarea>
                            </div>

                            <div class="form-group span-3">
                                <label for="projectGoals">Project Goals & Expectations</label>
                                <textarea id="projectGoals" name="projectGoals" class="form-input"
                                    placeholder="What do you hope to achieve? (e.g., increase capacity by 30%, reduce walking distance, improve safety compliance...)"></textarea>
                            </div>
...
<section class="pulse-cta">
    <div class="pulse-cta-inner">
        ...
        <p>Not ready for a Pulse Check yet? No problem. Reach out to us with any questions about our approach or how we
            might help.</p>
