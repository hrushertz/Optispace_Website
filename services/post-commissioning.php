...
$bannerQuery = "SELECT * FROM banner_settings WHERE page_name = 'post-commissioning' AND is_active = 1 ORDER BY sort_order ASC, created_at DESC";
...
if (empty($activeBanners)) {
    $activeBanners[] = [
        'image_path' => '',
        'eyebrow_text' => 'Post-Commissioning Support',
        'heading_html' => 'LFB Post-Commissioning <span>Support</span>',
...
<style>
   ...
   ======================================== */
    ...
    .hero-slide-content .pcs-hero-text,
    ...
    .hero-slide-content:not(.active) .pcs-hero-text,
    ...
    .hero-slide-content.active .pcs-hero-text {
        opacity: 1;
        transform: translateY(0);
            ...
            <div class="hero-content">
                <?php foreach ($activeBanners as $index => $banner): ?>
                    <div class="hero-slide-content <?php echo $index === 0 ? 'active' : ''; ?>"
                        ...
                        <p class="pcs-hero-text"><?php echo htmlspecialchars($banner['subheading']); ?></p>
                    </div>
                <?php endforeach; ?>
            </div>
...
<section class="pcs-section">
    <div class="pcs-container">
        <div class="pcs-section-header">
            ...
            <p>Post‑commissioning support from OptiSpace ensures your Lean Factory Building (LFB) design translates into
                stable, high‑performing daily operations</p>
        </div>
        ...
        <div class="content-grid">
            <div class="content-card">
                ...
                <p><strong>Our team bridges the critical gap between architectural drawings and day‑to‑day
                        operations.</strong></p>
            </div>
            <div class="feature-card">
                <h3>Why Continued Support Matters</h3>
                <p><strong>Facilities designed with LFB principles achieve faster and more stable performance when
                        supported by experts through this transition phase.</strong></p>
                <ul>
                    <li><span><strong>Faster ramp-up</strong> to full production capacity</span></li>
                    <li><span><strong>Higher adoption</strong> of new processes and layouts</span></li>
                    <li><span><strong>Better sustainability</strong> of lean improvements</span></li>
                    <li><span><strong>Quicker resolution</strong> of operational issues</span></li>
                    <li><span><strong>Continuous improvement</strong> culture development</span></li>
                </ul>
...
<section class="pcs-section section-light">
    <div class="pcs-container">
        <div class="pcs-section-header">
            ...
            <p>Moving a factory is a high-risk operation. When moving into an LFB‑designed facility, we help ensure
                equipment placement, material flows, and line-side stocking match the intended design exactly.</p>
        </div>
        ...
        <div class="content-grid-3">
            ...
            <div class="content-card">
                ...
                <p class="outcome">Outcome: This reduces ramp‑up time and avoids the early chaos often seen in new
                    facilities.</p>
            </div>
        </div>
...
<section class="pcs-section">
    <div class="pcs-container">
        <div class="pcs-section-header">
            ...
            <p>A well-designed layout should speak for itself. Visual factory deployment makes the LFB layout
                self‑explaining, allowing operators and supervisors to manage by sight, reducing training time and
                errors.</p>
        </div>
        ...
        <div class="content-grid">
            <div class="content-card">
                ...
                <p>A workplace designed so that anyone can understand the status of operations at a glance, without
                    asking questions or checking computer systems.</p>
                <p>Visual management transforms your factory floor into a self-explaining, self-regulating system where
                    problems surface immediately and solutions are obvious.</p>
            </div>
            <div class="content-card">
...
<section class="pcs-section section-light">
    <div class="pcs-container">
        <div class="pcs-section-header">
            ...
            <p>LFB defines the physical flow; production planning and control align schedules and capacities to that
                physical reality.</p>
        </div>
...
<section class="pcs-section">
    <div class="pcs-container">
        <div class="pcs-section-header">
            ...
            <p>Your supply chain must follow the new takt and material routes defined by LFB; we help you realign it.
            </p>
        </div>
...
<section class="pcs-section section-light">
    <div class="pcs-container">
        <div class="pcs-section-header">
            ...
            <p>Post‑commissioning support is designed to build your internal capability to sustain and improve on the
                LFB baseline</p>
        </div>
...
<section class="pcs-cta">
    <div class="pcs-container">
        <div class="cta-inner">
            ...
            <p>Our post-commissioning support helps your team achieve operational excellence in your LFB-designed
                facility. From stabilization to continuous improvement.</p>
