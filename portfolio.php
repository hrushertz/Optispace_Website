...
$bannerQuery = "SELECT * FROM banner_settings WHERE page_name = 'portfolio' AND is_active = 1 ORDER BY sort_order ASC, created_at DESC";
...
if (empty($activeBanners)) {
    $activeBanners[] = [
        'image_path' => '',
        'eyebrow_text' => 'Proven Results',
        'heading_html' => 'Our Portfolio & <span>Success Stories</span>',
...
<style>
   ...
   ======================================== */
    ...
    .hero-slide-content .portfolio-hero-text {
        opacity: 0;
    ...
    .hero-slide-content:not(.active) .portfolio-hero-text {
    ...
    .hero-slide-content.active .portfolio-hero-text {
        opacity: 1;
        transform: translateY(0);
    ...
    .before-side .comparison-list li svg {
        color: #EF4444;
    }

    .after-side .comparison-list li svg {
        color: var(--portfolio-green);
    }
        ...
        <div class="hero-content-wrapper">
            <?php foreach ($activeBanners as $index => $banner): ?>
                <div class="hero-slide-content <?php echo $index === 0 ? 'active' : ''; ?>"
                    ...
                    <p class="portfolio-hero-text"><?php echo htmlspecialchars($banner['subheading']); ?></p>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="portfolio-container">
        ...
        <div class="designs-grid">
            <div class="design-card">
                ...
                <p>Complete sets of architectural plans, elevations, sections, and details for new factory buildings.
                </p>
                ...
                <div class="innovation-content">
                    ...
                    <ul class="innovation-list">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            </svg> Gravity-fed presentation systems</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Custom assembly trolleys</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> FIFO flow racks</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Modular conveyor systems</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Auto door close</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Safe lift</li>
                    </ul>
            ...
            <div class="innovation-card">
                ...
                <div class="innovation-content">
                    ...
                    <ul class="innovation-list">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Height-adjustable stations</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Integrated tool presentation</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Work instruction displays</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Ergonomic solutions</li>
                    </ul>
                </div>
            </div>
            <div class="innovation-card">
                ...
                <div class="innovation-content">
                    ...
                    <ul class="innovation-list">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Visual count-free storage</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Color-coded locations</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Kanban card systems</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Supermarket layouts</li>
                    </ul>
                </div>
            </div>
            <div class="innovation-card">
                ...
                <div class="innovation-content">
                    ...
                    <ul class="innovation-list">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Production tracking boards</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Andon systems</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Floor marking systems</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Shadow boards</li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="portfolio-section alt-bg">
    <div class="portfolio-container">
            ...
            <div class="comparison-grid">
                <div class="comparison-side before-side">
                    ...
                    <ul class="comparison-list">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                ...
                                <path d="M15 9l-6 6" />
                                <path d="M9 9l6 6" />
                            </svg> Spaghetti flow with excessive material travel</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <path d="M15 9l-6 6" />
                                <path d="M9 9l6 6" />
                            </svg> Equipment placed without layout planning</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <path d="M15 9l-6 6" />
                                <path d="M9 9l6 6" />
                            </svg> Large WIP inventory between operations</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <path d="M15 9l-6 6" />
                                <path d="M9 9l6 6" />
                            </svg> Operators walking excessive distances</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <path d="M15 9l-6 6" />
                                <path d="M9 9l6 6" />
                            </svg> Congestion and bottlenecks</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <path d="M15 9l-6 6" />
                                <path d="M9 9l6 6" />
                            </svg> Difficult to manage and visualize</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                                <path d="M15 9l-6 6" />
                                <path d="M9 9l6 6" />
                            </svg> Poor space utilization</li>
                    </ul>
                </div>
                <div class="comparison-side after-side">
                    ...
                    <ul class="comparison-list">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Streamlined flow with minimal travel</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Equipment positioned for optimal sequence</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Minimal WIP with balanced flow</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Operators work within compact cells</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Clear aisles and organized zones</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Visual management throughout</li>
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polyline points="20 6 9 17 4 12" />
                            </svg> Efficient space with room for growth</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="request-banner" style="margin-top: 3rem;">
            ...
            <p>Before/after layouts and flows can be shared in a one-to-one discussion, subject to client
                confidentiality.</p>
