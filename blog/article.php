...
// Get author initials
$authorInitials = '';
$nameParts = explode(' ', $article['author_name']);
...
<section class="article-hero">
    <div class="article-hero-inner">
        <div class="article-meta-top">
            <a href="<?php echo url('blogs.php'); ?>#<?php echo htmlspecialchars($article['category_slug']); ?>" class="article-category-badge">
        ...
        <div class="article-author-card">
            ...
            <div class="author-info-details">
                <span class="author-info-name"><?php echo htmlspecialchars($article['author_name']); ?></span>
        ...
        <article class="article-content">
            ...
            <div class="share-section">
                ...
                <div class="share-buttons">
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode(url('blog/article.php?slug=' . $article['slug'])); ?>&title=<?php echo urlencode($article['title']); ?>" target="_blank" class="share-btn" title="Share on LinkedIn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(url('blog/article.php?slug=' . $article['slug'])); ?>&text=<?php echo urlencode($article['title']); ?>" target="_blank" class="share-btn" title="Share on Twitter">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"/>
                        </svg>
                    </a>
                    <a href="mailto:?subject=<?php echo urlencode($article['title']); ?>&body=<?php echo urlencode('Check out this article: ' . url('blog/article.php?slug=' . $article['slug'])); ?>" class="share-btn" title="Share via Email">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="related-grid">
            ...
            <a href="<?php echo url('blog/article.php?slug=' . $related['slug']); ?>" class="related-card">
                ...
                <div class="related-card-content">
                    ...
                    <div class="related-card-meta"><?php echo date('M j, Y', strtotime($related['published_at'])); ?> • <?php echo $related['read_time']; ?> min read</div>
                </div>
            </a>
            <?php endwhile; ?>
        </div>
