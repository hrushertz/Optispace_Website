            ...
            <div class="header-content">
                ...
                <nav class="mobile-nav-panel">
                    ...
                    <ul class="mobile-nav-list">
                        <li><a href="<?php echo url('index.php'); ?>" class="<?php echo ($currentPage ?? '') == 'home' ? 'active' : ''; ?>">Home</a></li>
                        <li><a href="<?php echo url('philosophy.php'); ?>" class="<?php echo ($currentPage ?? '') == 'philosophy' ? 'active' : ''; ?>">Philosophy</a></li>
                        <li class="mobile-has-submenu">
                            <a href="#" class="mobile-submenu-toggle <?php echo in_array(($currentPage ?? ''), ['greenfield', 'brownfield', 'post-commissioning']) ? 'active' : ''; ?>">
                                Services
                            ...
                            <ul class="mobile-submenu">
                                ...
                                <li><a href="<?php echo url('services/post-commissioning.php'); ?>">Post-Commissioning</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="mobile-has-submenu">
                            <a href="#" class="mobile-submenu-toggle <?php echo in_array(($currentPage ?? ''), ['downloads', 'blogs', 'gallery']) ? 'active' : ''; ?>">
                                Resources
                                <svg class="mobile-dropdown-icon" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <polyline points="6 9 12 15 18 9"/>
                                </svg>
                ...
                <nav class="main-nav">
                    <ul>
                        ...
                        <li class="has-submenu">
                            <a href="#" class="nav-dropdown-toggle <?php echo in_array(($currentPage ?? ''), ['greenfield', 'brownfield', 'post-commissioning']) ? 'active' : ''; ?>">
                                Services
                        ...
                        <li class="has-submenu">
                            <a href="#" class="nav-dropdown-toggle <?php echo in_array(($currentPage ?? ''), ['downloads', 'blogs', 'gallery']) ? 'active' : ''; ?>">
                                Resources
                                <svg class="dropdown-icon" width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L5 5L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
