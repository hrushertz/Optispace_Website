...
/* Print Styles */
@media print {
    .admin-sidebar, .admin-header, .no-print, .page-actions, .admin-notes-section {
...
<div class="print-header">
    ...
    <p><?php echo htmlspecialchars($submission['company_name']); ?> - <?php echo date('F j, Y', strtotime($submission['created_at'])); ?></p>
</div>

<div class="page-header no-print">
    <div class="page-title-section">
        <a href="pulse-checks.php" style="display: inline-flex; align-items: center; gap: 0.5rem; color: #64748B; text-decoration: none; font-size: 0.9rem; margin-bottom: 0.5rem;">
    ...
    <div class="detail-main">
        ...
        <div class="detail-card">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value"><?php echo htmlspecialchars(ucfirst($submission['industry'] ?: 'Not specified')); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Website</div>
                <div class="detail-value">
                    <?php if ($submission['website']): ?>
                        <a href="<?php echo htmlspecialchars($submission['website']); ?>" target="_blank" style="color: #3B82F6;">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">
                    <?php 
                    $address = [];
                    if ($submission['facility_address']) $address[] = $submission['facility_address'];
                    if ($submission['facility_city']) $address[] = $submission['facility_city'];
                    if ($submission['facility_state']) $address[] = $submission['facility_state'];
                    if ($submission['facility_country']) $address[] = $submission['facility_country'];
            ...
            <div class="detail-row">
                ...
                <div class="detail-value"><?php echo htmlspecialchars($submission['facility_size'] ? $submission['facility_size'] . ' sq. ft.' : 'Not specified'); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Employees</div>
                <div class="detail-value"><?php echo htmlspecialchars($submission['employees'] ?: 'Not specified'); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Annual Revenue</div>
                <div class="detail-value"><?php echo htmlspecialchars($submission['annual_revenue'] ?: 'Not specified'); ?></div>
            </div>
        </div>
        ...
        <div class="detail-card">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value highlight"><?php echo htmlspecialchars($submission['first_name'] . ' ' . $submission['last_name']); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Designation</div>
                <div class="detail-value"><?php echo htmlspecialchars($submission['designation'] ?: 'Not provided'); ?></div>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value"><?php echo htmlspecialchars(ucfirst($submission['preferred_contact'] ?: 'Not specified')); ?></div>
            </div>
        </div>
        ...
        <div class="detail-card">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value highlight"><?php echo htmlspecialchars(ucfirst(str_replace('-', ' ', $submission['project_type'] ?: 'Not specified'))); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Timeline</div>
                <div class="detail-value"><?php echo htmlspecialchars(ucfirst(str_replace('-', ' ', $submission['timeline'] ?: 'Not specified'))); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Referral Source</div>
                <div class="detail-value"><?php echo htmlspecialchars(ucfirst($submission['referral'] ?: 'Not specified')); ?></div>
            </div>
            ...
            <div class="detail-row" style="flex-direction: column;">
                ...
                <div class="interest-tags">
                    ...
                    foreach ($interests as $interest): 
                        ...
                        if ($interest):
                    ?>
                        <span class="interest-tag"><?php echo htmlspecialchars(ucfirst(str_replace('-', ' ', $interest))); ?></span>
                    <?php 
                        endif;
                    endforeach; 
                    ?>
            ...
            <div style="margin-top: 1.5rem;">
                <div class="detail-label" style="margin-bottom: 0.75rem; width: 100%;">Project Goals & Expectations</div>
    ...
    <div class="detail-sidebar no-print">
        <div class="detail-card sidebar-card admin-notes-section">
            ...
            <form method="POST" class="status-form">
                ...
                <label style="font-size: 0.85rem; color: #64748B; display: block; margin-bottom: 0.5rem;">Update Status</label>
                <select name="status" onchange="this.form.submit()">
                    ...
                    <option value="scheduled" <?php echo $submission['status'] === 'scheduled' ? 'selected' : ''; ?>>Scheduled</option>
                    <option value="completed" <?php echo $submission['status'] === 'completed' ? 'selected' : ''; ?>>Completed</option>
                    <option value="declined" <?php echo $submission['status'] === 'declined' ? 'selected' : ''; ?>>Declined</option>
                </select>
            </form>
            
            <!-- Admin Notes -->
            <form method="POST" style="margin-top: 1.25rem;">
                <label style="font-size: 0.85rem; color: #64748B; display: block; margin-bottom: 0.5rem;">Internal Notes</label>
                <textarea name="admin_notes" class="notes-textarea" placeholder="Add notes about this lead..."><?php echo htmlspecialchars($submission['admin_notes'] ?? ''); ?></textarea>
                <button type="submit" class="btn btn-primary" style="width: 100%;">Save Notes</button>
            </form>
            
            <!-- Quick Actions -->
            <div style="margin-top: 1.5rem;">
                <label style="font-size: 0.85rem; color: #64748B; display: block; margin-bottom: 0.75rem;">Quick Actions</label>
                <div class="quick-actions">
                    <a href="mailto:<?php echo htmlspecialchars($submission['email']); ?>?subject=Re: Pulse Check Request - <?php echo urlencode($submission['company_name']); ?>" class="quick-action-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <?php if ($submission['website']): ?>
                    <a href="<?php echo htmlspecialchars($submission['website']); ?>" target="_blank" class="quick-action-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="meta-info">
                ...
                <?php endif; ?>
                <p><strong>IP Address:</strong> <?php echo htmlspecialchars($submission['ip_address'] ?: 'Not captured'); ?></p>
            </div>
        </div>
        ...
        <div class="detail-card" style="margin-top: 1rem; border-color: #FEE2E2;">
            ...
            <p style="font-size: 0.85rem; color: #64748B; margin-bottom: 1rem;">Once deleted, this submission cannot be recovered.</p>
            <a href="pulse-checks.php?delete=<?php echo $submission['id']; ?>" 
               class="btn" 
