...
<style>
@media print {
    .sidebar, .topbar, .page-header, .btn, .action-buttons, .danger-zone, form, .no-print {
...
<div class="print-header">
    ...
    <p>Submission #<?php echo $submission['id']; ?> | <?php echo date('F j, Y g:i A', strtotime($submission['created_at'])); ?></p>
</div>
...
<div class="page-header">
    <div class="page-title-section">
        ...
        <p class="page-subtitle">Submitted on <?php echo date('F j, Y \a\t g:i A', strtotime($submission['created_at'])); ?></p>
    </div>
...
<div class="detail-grid">
    ...
    <div class="detail-card no-print">
        ...
        <div class="detail-card-body">
            <form method="POST" style="margin-bottom: 1.5rem;">
                ...
                <label style="display: block; font-size: 0.875rem; color: #64748B; margin-bottom: 0.5rem; font-weight: 500;">Update Status</label>
            ...
            <label style="display: block; font-size: 0.875rem; color: #64748B; margin-bottom: 0.5rem; font-weight: 500;">Quick Actions</label>
            <div class="action-buttons">
                <a href="mailto:<?php echo htmlspecialchars($submission['email']); ?>" class="quick-action quick-action-email">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <?php if ($submission['phone']): ?>
                <a href="tel:<?php echo htmlspecialchars($submission['phone']); ?>" class="quick-action quick-action-phone">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="detail-card" style="grid-column: 1 / -1;">
        ...
        <div class="detail-card-body">
            <p style="margin: 0; font-weight: 600; color: #1E293B;"><?php echo htmlspecialchars($submission['subject']); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="detail-card message-card no-print">
        ...
        <div class="detail-card-body">
            <form method="POST">
                ...
                <textarea name="admin_notes" class="notes-textarea" placeholder="Add internal notes about this inquiry..."><?php echo htmlspecialchars($submission['admin_notes'] ?? ''); ?></textarea>
...
<div class="meta-info">
    ...
    <span><strong>User Agent:</strong> <?php echo htmlspecialchars(substr($submission['user_agent'] ?? 'N/A', 0, 100)); ?>...</span>
</div>
