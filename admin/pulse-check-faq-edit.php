            ...
            <div class="form-grid">
                <div class="form-group span-full">
                    ...
                    <input type="text" id="question" name="question" class="form-control"
                        ...
                        value="<?php echo htmlspecialchars($_POST['question'] ?? $faq['question']); ?>" required>
                ...
                <div class="form-group span-full">
                    ...
                    <small class="form-text">Use the rich text editor to format your answer with headings, lists, bold,
                        italic, etc.</small>
                </div>

                <div class="form-group span-full">
                    <label class="checkbox-label">
                        <input type="checkbox" name="is_active" <?php echo (isset($_POST['is_active']) ? 'checked' : ($faq['is_active'] ? 'checked' : '')); ?>>
