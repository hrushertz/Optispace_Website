                        ...
                        <tr>
                            <td>
                                <div class="blog-title-cell">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($blog['excerpt']): ?>
                                        <p class="blog-excerpt"><?php echo htmlspecialchars(substr($blog['excerpt'], 0, 80)); ?>...
                                        </p>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td>
                                <div class="author-cell">
                                    ...
                                    <span
                                        class="author-role"><?php echo ucfirst(str_replace('_', ' ', $blog['author_role'])); ?></span>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="blog-edit.php?id=<?php echo $blog['id']; ?>" class="btn-icon" title="Edit Blog">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <?php if ($blog['is_published']): ?>
                                        <a href="?toggle=unpublish&id=<?php echo $blog['id']; ?>&token=<?php echo generateCsrfToken(); ?>"
                                            class="btn-icon" title="Unpublish" onclick="return confirm('Unpublish this blog?');">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                <path
                                    ...
                                    <?php if ($blog['is_published']): ?>
                                        <a href="/blog/article.php?slug=<?php echo urlencode($blog['slug']); ?>" class="btn-icon"
                                            title="View Live" target="_blank">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
