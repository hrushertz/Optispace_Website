...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="pulse-check-bulk.php" class="btn btn-secondary">
        ...
        <a href="pulse-check-add.php" class="btn btn-primary">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                style="width: 18px; height: 18px;">
...
<div class="stats-grid">
    <a href="?status=" class="stat-card <?php echo $statusFilter === '' ? 'active' : ''; ?>"
    ...
    <a href="?status=scheduled" class="stat-card <?php echo $statusFilter === 'scheduled' ? 'active' : ''; ?>"
        style="text-decoration: none;">
                ...
                <?php if ($submissions->num_rows > 0): ?>
                    <?php while ($row = $submissions->fetch_assoc()): ?>
                        <tr class="submission-row"
                            onclick="window.location='pulse-check-view.php?id=<?php echo $row['id']; ?>'">
                            <td>#<?php echo $row['id']; ?></td>
                            <td>
                                <div class="company-info">
                                    <span class="company-name"><?php echo htmlspecialchars($row['company_name']); ?></span>
                                    <span
                                        class="company-industry"><?php echo htmlspecialchars($row['industry'] ?: 'N/A'); ?></span>
                                </div>
                            </td>
                            <td>
                                <div class="contact-info">
                                    <span
                                        class="contact-name"><?php echo htmlspecialchars($row['first_name'] . ' ' . $row['last_name']); ?></span>
                                    <span class="contact-email"><?php echo htmlspecialchars($row['email']); ?></span>
                                </div>
                            </td>
                            <td><?php echo htmlspecialchars($row['phone']); ?></td>
                            <td><?php echo htmlspecialchars(ucfirst(str_replace('-', ' ', $row['project_type'] ?: 'N/A'))); ?>
                            </td>
                                ...
                                <form method="POST" style="display: inline;">
                                    ...
                                    <select name="status" class="status-dropdown" onchange="this.form.submit()">
                                        ...
                                        <option value="contacted" <?php echo $row['status'] === 'contacted' ? 'selected' : ''; ?>>
                                            Contacted</option>
                                        <option value="scheduled" <?php echo $row['status'] === 'scheduled' ? 'selected' : ''; ?>>
                                            Scheduled</option>
                                        <option value="completed" <?php echo $row['status'] === 'completed' ? 'selected' : ''; ?>>
                                            Completed</option>
                                        <option value="declined" <?php echo $row['status'] === 'declined' ? 'selected' : ''; ?>>
                                            Declined</option>
                                    </select>
                                </form>
                            </td>
                            ...
                            <td onclick="event.stopPropagation();">
                                <div class="action-buttons">
                                    <a href="pulse-check-view.php?id=<?php echo $row['id']; ?>" class="btn-icon"
                                        title="View Details">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <a href="pulse-check-edit.php?id=<?php echo $row['id']; ?>" class="btn-icon" title="Edit">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
