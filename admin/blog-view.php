...
<div class="page-header">
    ...
    <div class="page-actions">
        ...
        <?php endif; ?>
        <a href="blog-edit.php?id=<?php echo $blogId; ?>" class="btn btn-primary">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="card-body">
                ...
                <?php if ($blog['video_url']): ?>
                    <div class="content-section">
                        ...
                        <p class="code"><?php echo htmlspecialchars($blog['video_url']); ?></p>
                        <a href="<?php echo htmlspecialchars($blog['video_url']); ?>" target="_blank"
                            style="font-size: 0.85rem; color: #3B82F6;">Open Link</a>
                    </div>
                <?php endif; ?>
            ...
            <div class="card-body">
                <div class="detail-row">
                    ...
                    <div class="detail-value">
                        ...
                        <span
                            class="role-badge"><?php echo ucfirst(str_replace('_', ' ', $blog['author_role'])); ?></span>
                    </div>
                </div>
                    ...
                    <span class="detail-value">
                        <?php if ($blog['category_name']): ?>
                            <span class="category-badge"
                                style="background: <?php echo $blog['category_color'] ?? '#64748B'; ?>20; color: <?php echo $blog['category_color'] ?? '#64748B'; ?>">
                ...
                <div class="detail-row">
                    ...
                    <span
                        class="detail-value"><?php echo date('M j, Y g:i A', strtotime($blog['created_at'])); ?></span>
                </div>
                ...
                <?php if ($blog['published_at']): ?>
                    <div class="detail-row">
                        ...
                        <span
                            class="detail-value"><?php echo date('M j, Y g:i A', strtotime($blog['published_at'])); ?></span>
                    </div>
                <?php endif; ?>
                ...
                <?php if ($blog['updated_at'] && $blog['updated_at'] !== $blog['created_at']): ?>
                    <div class="detail-row">
                        ...
                        <span
                            class="detail-value"><?php echo date('M j, Y g:i A', strtotime($blog['updated_at'])); ?></span>
                    </div>
                <?php endif; ?>
            </div>
        </div>
