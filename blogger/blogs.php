                ...
                <?php if ($blogs->num_rows > 0): ?>
                    <?php while ($blog = $blogs->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <span
                                    class="badge badge-gray"><?php echo htmlspecialchars($blog['category_name'] ?? 'Uncategorized'); ?></span>
                            </td>
                            <td>
                                <?php
                                $isScheduled = $blog['is_published'] && $blog['published_at'] && strtotime($blog['published_at']) > time();
                                if ($isScheduled): ?>
                                    <span class="badge" style="background: #EFF6FF; color: #3B82F6;">Scheduled</span>
                                <?php elseif ($blog['is_published']): ?>
                            ...
                            <td>
                                <?php if ($blog['published_at']): ?>
                                    <?php echo date('M j, Y H:i', strtotime($blog['published_at'])); ?>
                                <?php else: ?>
                            ...
                            <td>
                                <div class="table-actions">
                                    ...
                                    <a href="?toggle=<?php echo $blog['id']; ?>" class="btn btn-secondary btn-sm btn-icon"
                                    ...
                                    <?php if ($blog['is_published']): ?>
                                        <a href="../blog/article.php?slug=<?php echo $blog['slug']; ?>" target="_blank"
                        ...
                        <td colspan="6">
                            <div class="empty-state" style="padding: 3rem;">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"
                                    style="width: 64px; height: 64px; color: #cbd5e1; margin-bottom: 1rem;">
