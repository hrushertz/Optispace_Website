...
// Fetch Active Banners for Gallery Page
$bannerQuery = "SELECT * FROM banner_settings WHERE page_name = 'gallery' AND is_active = 1 ORDER BY sort_order ASC, created_at DESC";
...
// Fallback for Gallery Banner
if (empty($activeBanners)) {
    $activeBanners[] = [
        'image_path' => '',
        'eyebrow_text' => 'Visual Portfolio',
        'heading_html' => 'Project <span>Gallery</span>',
...
<style>
   ...
   ======================================== */
    ...
    .hero-slide-content .gallery-hero-content {
        opacity: 0;
        transform: translateY(30px);
        transition: all 1s cubic-bezier(0.16, 1, 0.3, 1);
    }

    .hero-slide-content:not(.active) .gallery-hero-content {
        transform: translateY(-20px);
        opacity: 0;
        transition: all 0.5s ease;
    }

    .hero-slide-content.active .gallery-hero-content {
        opacity: 1;
                ...
                <div class="gallery-item" data-category="<?php echo htmlspecialchars($item['category_slug']); ?>">
                    <div class="gallery-card">
                        ...
                        <div class="gallery-info">
                            <span
                                class="gallery-tag <?php echo htmlspecialchars($item['category_slug']); ?>"><?php echo htmlspecialchars($item['category_name']); ?></span>
                ...
                <div class="featured-card <?php echo $isPrimary ? 'primary' : ''; ?>">
                    ...
                    <div class="featured-content">
                        <div class="featured-meta">
                            <span
                                class="gallery-tag <?php echo htmlspecialchars($categorySlug); ?>"><?php echo htmlspecialchars($categoryName); ?></span>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .lightbox-nav {
            top: 25%;
            /* Vertically align with image area approx */
            bottom: auto;
            transform: translateY(-50%);
            background: rgba(0, 0, 0, 0.5);
            width: 44px;
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function handleSwipe() {
            ...
            // Check if horizontal swipe is more significant than vertical (to allow scrolling)
    ...
    <div class="gallery-container">
        <div class="cta-card">
            <div class="cta-content">
                ...
                <p>Let us add your project to our success gallery. Start with a complimentary LFB Pulse Check
                    consultation.</p>
