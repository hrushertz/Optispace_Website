        ...
        if (empty($firstName) || empty($lastName) || empty($email) || empty($subject) || empty($message)) {
            ...
            if (!$stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    error_log("Contact form: MAIL_ENABLED = " . var_export($mailEnabled, true));
                    ...
                    if ($mailEnabled === true || $mailEnabled === 'true') {
                        ...
                        error_log("Contact form: Attempting to send email notification");
                        ...
                        if ($notificationResult['success']) {
                            ...
                            error_log("Contact form notification email failed: " . $notificationResult['message']);
                        }
                    } else {
                        error_log("Contact form: Email notifications disabled (MAIL_ENABLED not true)");
                    }
...
// Fetch Active Banners for Contact Page
$bannerQuery = "SELECT * FROM banner_settings WHERE page_name = 'contact' AND is_active = 1 ORDER BY sort_order ASC, created_at DESC";
...
// Fallback for Contact Banner
if (empty($activeBanners)) {
    $activeBanners[] = [
        'image_path' => '',
        'eyebrow_text' => 'Get In Touch',
        'heading_html' => "Let's Start a <span>Conversation</span>",
...
<style>
   ...
   ======================================== */
    ...
    :root {
        --contact-orange: #e99738;
        --contact-orange-light: rgba(233, 151, 56, 0.08);
        --contact-blue: #e99738;
        --contact-blue-light: rgba(233, 151, 56, 0.08);
        --contact-green: #e99738;
        --contact-green-light: rgba(233, 151, 56, 0.08);
        --contact-dark: #1E293B;
        --contact-text: #475569;
    ...
    .hero-slide-content .contact-hero-content {
        opacity: 0;
        transform: translateY(30px);
        transition: all 1s cubic-bezier(0.16, 1, 0.3, 1);
    }

    .hero-slide-content:not(.active) .contact-hero-content {
        transform: translateY(-20px);
        opacity: 0;
        transition: all 0.5s ease;
    }

    .hero-slide-content.active .contact-hero-content {
        opacity: 1;
            ...
            <?php foreach ($activeBanners as $index => $banner): ?>
                <div class="hero-slide-content <?php echo $index === 0 ? 'active' : ''; ?>"
                    ...
                    <div class="contact-hero-content">
                        ...
                        <p class="contact-hero-text"><?php echo htmlspecialchars($banner['subheading']); ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="contact-grid">
            ...
            <div class="contact-info-stack">
                <div class="contact-info-card">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            B 1/2, Suvidha Dyanganga, Jadhav Nagar,<br>
                            Vadgao BK, Pune 411041
                        </div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Additional Office</div>
                        <div class="info-value">
                            T-12, 3rd Floor, VTP Town Square,<br>
                            Mahalunge, Pune 411045
                        </div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">GST No</div>
                        <div class="info-value">27AADPU0566C1ZT</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">PAN No</div>
                        <div class="info-value">AADPU0566C</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Email</div>
                        <div class="info-value">
                            <a href="mailto:info@solutionsoptispace.com">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path
                                        d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                                    <polyline points="22,6 12,13 2,6" />
                                </svg>
                                info@solutionsoptispace.com
                            </a>
                        </div>
                    </div>
                    <div class="info-item">
                ...
                <div class="quick-connect-card">
                    ...
                    <p>Request a complimentary Pulse Check — our on-site visit to understand your facility and identify
            ...
            <div class="contact-form-card">
                <?php if ($formSuccess): ?>
                    <div style="text-align: center; padding: 2rem;">
                        <div
                            style="width: 80px; height: 80px; background: rgba(16, 185, 129, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 2rem;">
                        ...
                        <p
                            style="font-size: 1.1rem; color: #64748B; max-width: 500px; margin: 0 auto 2rem; line-height: 1.7;">
                            Your message has been sent successfully. Our team will review your inquiry and get back to you
                            shortly.</p>
                        <a href="<?php echo url('index.php'); ?>"
                            style="display: inline-flex; align-items: center; gap: 0.5rem; background: #E99431; color: white; padding: 1rem 2rem; border-radius: 8px; text-decoration: none; font-weight: 600;">
...
<section class="contact-cta">
    <div class="contact-cta-inner">
        ...
        <p>Take the first step with a complimentary Pulse Check. We'll assess your facility and show you the potential
            for improvement.</p>
